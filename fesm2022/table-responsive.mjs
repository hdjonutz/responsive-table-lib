...
import { Directive, TemplateRef, Input, ContentChild, Injectable, EventEmitter, Output, Component, ViewChild, ChangeDetectionStrategy, ContentChildren, Pipe, NgModule } from '@angular/core';
